...
Como o Bazzite é um sistema baseado em imagens atômicas (Fedora Silverblue/Kinoite), use o `rpm-ostree` para instalar pacotes diretamente no sistema de arquivos imutável:
...
Após a instalação terminar com sucesso, certifique-se de reiniciar o seu computador para que o sistema monte a nova camada do sistema e o Kitty apareça no seu menu de aplicativos.
